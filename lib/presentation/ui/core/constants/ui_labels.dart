abstract class UiLabels {
  static const retryLabel = 'Retry';
  static const emptyPostsTitle = 'No posts available';
  static const emptyPostDescription =
      'There are currently no posts to display. Check back later for updates.';
