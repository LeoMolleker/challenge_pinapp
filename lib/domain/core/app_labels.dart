abstract class AppLabels{
  static const failedPostsTitle = 'Failed to load posts';
  static const failedPostDescription = 'There was an issue loading the posts. Pleas check your internet connection and try again.';
